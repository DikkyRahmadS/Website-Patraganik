...
<body class="app sidebar-mini rtl ">
    ...
    <header class="app-header"><a class="app-header__logo bg-success" href="index.php?halaman=beranda">Patraganik III</a>
    ...
    <aside class="app-sidebar bg-success">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" width="25%" height="25%" src="assets_admin/docs/<?= $pecah['fotoprofil']; ?>" alt="User Image">
            <div>
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="index.php?halaman=pengguna"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Data Akun Pelanggan</span></a></li>
            <li><a class="app-menu__item" href="index.php?halaman=ubahpengguna"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Kelola Akun</span></a></li>
        </ul>
    </aside>
