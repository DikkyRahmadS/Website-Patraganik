...
<body style='font-family:tahoma; font-size:8pt;padding-top:50px'>
    <table style='width:660; font-size:16pt; font-family:calibri; border-collapse: collapspe;' border='0'>
        <tr>
            <td style="padding-left:80px"><img src="foto/lgbr.png" width="90" height="90"></td>
            <td>
                <center>
                    <font size="6"><b>Patraganik III</b></font><br>
                    <font size="3"><b>JL. Pulau Layang, Sungai Pinang, Kec. Plaju, Kab. Banyuasin, Sumatera Selatan 30967<br>Telp : 0852 7975 2323, Email : patraganik.iii.plaju@gmail.com</b>
                    </font><br>
                </center>
            </td>
        </tr>
    ...
    <center>
        <table style='width:660; font-size:16pt; font-family:calibri; border-collapse: turunbawah;' border='0'>
            ...
            <tr>
                <td>
                    <span style="font-size:11pt">Metode Pembayaran</span>
                </td>
                <td>
                    <span style="font-size:11pt"> : <?= $pecah['metodepembayaran'] ?></span>
                </td>
            </tr>
        </table>
        <br><br>
